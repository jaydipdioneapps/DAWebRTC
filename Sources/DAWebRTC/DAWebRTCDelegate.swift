...
public protocol DAWebRTCDelegate: AnyObject {
    ...
    func daWebRTC(_ manager: DAWebRTC, didCreateOffer channelName: String, sdp: String, recieverId: String, isAudioToVideo: String, videoCallRequestAccepted: String, type: String)
    func daWebRTC(_ manager: DAWebRTC, sendOfferFromSDP channelName: String, sdp: String, recieverId: String, type: String)
    func daWebRTC(_ manager: DAWebRTC, callCut channelName: String, recieverId: String, type: String)
    func daWebRTC(_ manager: DAWebRTC, didDisconnectedUser channelName: String, userId: String, duration: Int)
    func daWebRTC(_ manager: DAWebRTC, sendAudioMuteStatus channelName: String, recieverId: String, audioMuted: String, type: String)
    func daWebRTC(_ manager: DAWebRTC, sendVideoMuteStatus channelName: String, recieverId: String, videoMuted: String, type: String)
